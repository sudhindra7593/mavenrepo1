 ...
 This will deploy two artifacts, target/sai2.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/sai2.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/sai2.war

 To undeploy the application, run:

  ./asadmin undeploy sai2
